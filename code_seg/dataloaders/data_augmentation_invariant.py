...
def without_augmentation(image):
    return image
...
def augmentation_invariant_transformtion(image):
    ...
    func = random.sample([without_augmentation, random_noise, random_equalize_hist, random_rescale_intensity, random_sharpening, nonlinear_transformation], 2)
    aug_image_one = func[0](image)
    # aug_image_two = func[1](aug_image_one)
    # return aug_image_two
    return aug_image_one